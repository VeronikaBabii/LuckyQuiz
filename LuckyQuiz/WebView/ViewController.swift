...
class ViewController: UIViewController {
    ...
    func checkWhatToShow() {
        ...
        //self.utils.printUserDefaults()
        
        if UserDefaults.standard.object(forKey: "SHOW_WEB") != nil {
            
            // show user notifications prompt here if it's a first launch
            showPushPrompt()
            
            // load url in webview
            let url = UserDefaults.standard.object(forKey: "AGREEMENT_URL")
        ...
        } else if UserDefaults.standard.object(forKey: "SHOW_GAME") != nil {
